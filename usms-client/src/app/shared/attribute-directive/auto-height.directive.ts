 ...
 * 用法：<div class="parentClassName"><div appAutoHeight="parentClassName"></div></div>
...
export class AppAutoHeightDirective implements AfterViewInit, AfterViewChecked {
  @Input('appAutoHeight') parentClassName: string; // 指定父节点类名
