...
http://192.168.200.209:8080/usms/v1/internalapi/user
...
```
http://192.168.200.209:8080/usms/v1/internalapi/user?login_name=admin&client_id=CLIENT_ID
```

(5) 输出参数

同 2.3.2 节 输出参数，附带该用户，登录该系统的access_token

(6) 输出样例

同 2.3.2 节 输出样例，附带该用户，登录该系统的access_token
...
```
http://192.168.200.209:8080/usms/v1/internalapi/user?user_id=22&client_id=CLIENT_ID
```
